...
У каждого участника НИСа свой глагол со своим набором существительных. Свой набор данных нужно найти здесь <ссылка>.  
...
* методом К-средних (см. хендаут clustering.ipynb).
